...
numOfFiles = 35; % enter # of csv files your state has
allTrips = table;
subFile = 1; 
FIPSCode = 35001; % enter the lowest FIPS code of the CSV files
i = 0;

% this part is for reading in the csv files - make necessary changes for
% state names, etc.
while i < numOfFiles
   fileName = strcat('NewMexicoPersonTrips/FinalOriginPixel', num2str(FIPSCode), '_', num2str(subFile), '.csv');
   if isfile(fileName)
